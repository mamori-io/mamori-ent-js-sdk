...
export enum MAMORI_PERMISSION {
    ...
    ALTER_LICENSE_KEY = "ALTER LICENSE KEY",
    ...
    CREATE_TABLE_WITHOUT_DESTINATION = "CREATE TABLE WITHOUT DESTINATION",
    CREATE_USER = "CREATE USER",
    DISABLE_CONNECTION_LOG = "DISABLE CONNECTION LOG",
    ...
    MAMORI_CATALOG = "MAMORI CATALOG",
    MAMORI_SECURITY_CATALOG = "MAMORI SECURITY CATALOG",
    MANAGE_DATASOURCE_GROUPS = "MANAGE DATASOURCE GROUPS",
    MASKING_RULE_ADMIN = "MASKING RULE ADMIN",
    MONITOR_ADMIN = "MONITOR ADMIN",
    MONITOR_EDITOR = "MONITOR EDITOR",
    MONITOR_VIEWER = "MONITOR VIEWER",
    POLICY = "POLICY",
    ...
    SET_NUMBEROFMAPPERS = "SET NUMBEROFMAPPERS",
    SET_NUMBEROFRDBMSTRANSFERTHREADS = "SET NUMBEROFRDBMSTRANSFERTHREADS",
    SET_NUMBEROFREDUCERS = "SET NUMBEROFREDUCERS",
    SET_NUMSQOOPMAPTASKS = "SET NUMSQOOPMAPTASKS",
    SET_PAUSECLEANUP = "SET PAUSECLEANUP",
    SET_RUNMODE = "SET RUNMODE",
    SET_SERVER_NAME = "SET SERVER_NAME",
    SET_SQOOP_OPTIONS = "SET SQOOP OPTIONS",
    SET_SYSTEM_PROPERTY = "SET SYSTEM PROPERTY",
    SYSTEM_MONITOR = "SYSTEM MONITOR",
    VALIDATE_USER = "VALIDATE USER",
    VIEW_ALL_USER_LOGS = "VIEW ALL USER LOGS",
    VIEW_CLEAR_SQL_ERROR_LOG = "VIEW CLEAR SQL ERROR LOG",
    VIEW_CLEAR_SQL_LOG = "VIEW CLEAR SQL LOG",
    WEB_AUTO_COMMIT = "WEB AUTO COMMIT",
