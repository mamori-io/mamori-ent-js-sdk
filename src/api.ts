...
export class MamoriService extends eventable.Eventable {
  ...
  has_priv(name: string): boolean {
    return this.claims.privs.find(
      (v: string) => v == name || v == "ALL PRIVILEGES",
    );
  }
  ...
  public async callAPI(
    ...
    url: string,
    params: any = null,
    callback: Nullable<ApiCallback> = null,
    cachable: boolean = false,
  ): Promise<any> {
    var deferred: Promise<any>;
    var cacheKey: string = cachable
      ? this.calculate_cache_key(url, params)
      : "";
    ...
    if (cachable) {
      ___api_request_cache___[cacheKey] = {
        deferred: deferred,
        resolved: false,
        value: null,
      };
  ...
  public change_password(old_password: string, new_password: string) {
    return this.callAPI("POST", "/v1/change_password", {
  ...
  public set_system_properties(jsonProperties: any) {
    return this.callAPI("PUT", "/v1/server_properties", {
      properties: jsonProperties,
    });
  }

  public set_system_property(name: string, value: any) {
    return this.callAPI("PUT", "/v1/server_properties/" + name, {
      value: value,
    });
  }
  ...
  public delete_masking_procedure(rmsid: number, name: string) {
    return this.callAPI("DELETE", "/v1/maskingprocedures/1", {
      name: name,
      rmsid: rmsid,
    });
  }
  ...
  public add_restricted_column(rms: string, column: string) {
    return this.callAPI("POST", "/v1/restricted_columns", {
      rms_name: rms,
      column_name: column,
    });
  }
  ...
  public drop_restricted_column(rms: string, column: string) {
    return this.callAPI("DELETE", "/v1/restricted_columns/1", {
      rms_name: rms,
      column_name: column,
    });
  }
  ...
  public user_roles(username: string) {
    return this.callAPI(
      "GET",
      "/v1/roles?isdef=N&grantee=" + encodeURIComponent(username.toLowerCase()),
    );
  }
  ...
  public grant_roles_to_user(username: string, roles: string[]) {
    return this.callAPI(
      "POST",
      "/v1/users/" + encodeURIComponent(username.toLowerCase()) + "/roles",
  ...
  public update_role_credentials(
    role: string,
    deleted_creds: string[],
    new_creds: string[],
  ) {
  ...
  public drop_role_credentials(role: string, credentials: string[]) {
    return this.callAPI("DELETE", "/v1/roles/" + role + "/credentials", {
      db_credentials: credentials,
    });
  }

  public add_role_credentials(role: string, credentials: string[]) {
    return this.callAPI("POST", "/v1/roles/" + role + "/credentials", {
      db_credentials: credentials,
    });
  }
  ...
  public grant_to(
    ...
    return this.callAPI(
      "POST",
      "/v1/grantee/" + encodeURIComponent(grantee.toLowerCase()),
      payload,
    ).then((r) => {
  ...
  public update_global_permission(
    rolename: string,
    deleted: string[],
    added: string[],
  ) {
    if (deleted.length > 0 && added.length > 0) {
      return this.callAPI(
        "PUT",
        "/v1/roles/" + rolename + "/global/permissions",
        {
      ...
      return this.revoke_global_permission(rolename, {
        deleted_permission: deleted,
      });
    } else if (added.length > 0) {
      return this.grant_global_permission(rolename, {
        selected_permissions_cirro: added,
      });
    } else {
      return;
    }
  ...
  public update_object_permission(
    rolename: string,
    deleted: string[],
    added: string[],
  ) {
    if (deleted.length > 0 && added.length > 0) {
      return this.callAPI(
        "PUT",
        "/v1/roles/" + rolename + "/object/permissions",
        {
      ...
      return this.revoke_object_permission(rolename, {
        deleted_permission_object: deleted,
      });
    } else if (added.length > 0) {
      return this.grant_object_permission(rolename, {
        selected_permissions_object: added,
      });
    }
  }

  public grantee_object_grants(
    grantee: string,
    permissionType: string,
    objectName: string,
  ) {
    return this.callAPI("GET", "/v1/grantee/" + grantee + "/grants", {
  ...
  public grant_global_permission(role: string, permissions: any) {
    return this.callAPI(
      "POST",
      "/v1/roles/" + role + "/grant/global/permissions",
      permissions,
    );
  }
  ...
  public revoke_object_permission(role: string, permissions: any) {
    return this.callAPI(
      "DELETE",
      "/v1/roles/" + role + "/grant/object/permissions",
      permissions,
    );
  }
  ...
  public grantee_privileges_recursive(grantees: string[]) {
    return this.callAPI("GET", "/v1/privileges?recursive=Y", {
      grantee: grantees,
    });
  }
  ...
  public get_provider(name: String) {
    return this.callAPI(
      "GET",
      "/v1/providers/" + encodeURIComponent(name.toLowerCase()),
    );
  }
  ...
  public validate_provider(
    provider: string,
    username: string,
    password: string,
  ) {
    return this.callAPI("POST", "/v1/provider/validate", {
      provider: provider,
      username: username,
      password: password,
    });
  ...
  public set_totp_properties(seconds: number, url: string) {
    return this.callAPI("PUT", "/v1/defaults/totpproperties", {
      seconds: seconds,
      url: url,
    });
  }
  ...
  public agent_drop(agent_name: string) {
    return this.callAPI(
      "DELETE",
      "/v1/agents/" + encodeURIComponent(agent_name),
    );
  }
  ...
  public database_validate_login(system_name: string, options: any) {
    return this.callAPI(
      "PUT",
      "/v1/objects/databases/" + encodeURIComponent(system_name) + "/validate",
      options,
    );
  }
  ...
  public database_schemas(system_name: string, database_name: string) {
    let url =
      "/v1/objects/databases/" +
      encodeURIComponent(system_name) +
      "?database=" +
      database_name;
    //console.info(url);
    return this.callAPI("GET", url);
  ...
  public system_group_systems_search(group: string, options: any) {
    return this.callAPI(
      "PUT",
      "/v1/systemgroups/" + group + "/systems",
      options,
    );
  }

  public system_group_add_system(group: string, system: string) {
    return this.callAPI("POST", "/v1/systemgroups/" + group + "/systems", {
      system: system,
    });
  }
  ...
  public system_group_remove_system(group: string, system: string) {
    return this.callAPI(
      "DELETE",
      "/v1/systemgroups/" + group + "/systems/" + system,
    );
  }

  public system_group_add_credential(
    group: string,
    grantee: string,
    login: string,
    pw: string,
  ...
  public system_group_remove_credential(group: string, options: any) {
    return this.callAPI(
      "POST",
      "/v1/systemgroups/" + group + "/credentials/delete",
      options,
    );
  }
  ...
  public system_group_credentials_search(group: string, options: any) {
    return this.callAPI(
      "PUT",
      "/v1/systemgroups/" + group + "/credentials",
      options,
    );
  }
  ...
  public user(username: string) {
    return this.callAPI(
      "GET",
      "/v1/users/" + encodeURIComponent(username.toLowerCase()),
    );
  }
  ...
  public notify_user(username: string) {
    return this.callAPI(
      "PUT",
      "/v1/users/" + encodeURIComponent(username.toLowerCase()) + "/notify",
    );
  }
  ...
  public delete_external_user(username: string) {
    return this.callAPI(
      "DELETE",
      "/v1/users/" + encodeURIComponent(username.toLowerCase()) + "/external",
    );
  }
  ...
  public disable_user(username: string) {
    return this.callAPI(
      "PUT",
      "/v1/users/" + encodeURIComponent(username.toLowerCase()) + "/disable",
    );
  }
  ...
  public unlock_user(username: string) {
    return this.callAPI(
      "PUT",
      "/v1/users/" + encodeURIComponent(username.toLowerCase()) + "/unlock",
    );
  }
  ...
  public user_options(username: string) {
    return this.callAPI(
      "GET",
      "/v1/users/" + encodeURIComponent(username.toLowerCase()) + "/options",
    );
  }
  ...
  public get_pending_user_sessions(username: string) {
    return this.callAPI(
      "GET",
      "/ua/sessions/" + encodeURIComponent(username.toLowerCase()),
    );
  }
  ...
  public get_grantee_policies(grantee: string) {
    return this.callAPI(
      "GET",
      "/v1/grantee/" + encodeURIComponent(grantee.toLowerCase()) + "/policies",
    );
  }
  ...
  public install_certs(name: string, ca_crt: string, key: string, crt: string) {
    return this.callAPI("POST", "/v1/certs", {
      name: name,
      certs: { key: key, crt: crt, ca_crt: ca_crt },
    });
  }
  ...
  public update_listener_logging(id: string, flag: boolean) {
    return this.callAPI("PUT", "/v1/listeners/" + id + "/logging", {
      detailed_logging: flag,
    });
  }
  ...
  public delete_policy(policy: string) {
    return this.callAPI(
      "DELETE",
      "/v1/policies/" + encodeURIComponent(policy.toLowerCase()),
    );
  }
  ...
  public policies_get_procedure_sql(procedure_name: string) {
    return this.callAPI(
      "GET",
      "/v1/policies/get_procedure_sql/" + procedure_name,
    );
  }
  ...
  public policies_get_procedure_parameters(procedure_name: string) {
    return this.callAPI(
      "GET",
      "/v1/policies/get_procedure_parameters/" + procedure_name,
    );
  }
  ...
  public policies_get_procedure_options(procedure_name: string) {
    return this.callAPI(
      "GET",
      "/v1/policies/get_procedure_options/" + procedure_name,
    );
  }
  ...
  public policies_get_request_parameters(request_key: string) {
    return this.callAPI(
      "GET",
      "/v1/policies/get_request_parameters/" + request_key,
    );
  }

  public policies_request_execute(
    procedure_name: string,
    parameters: any,
    message: string,
  ) {
    return this.callAPI("POST", "/v1/policies/request_execute", {
  ...
  public policies_request_action(
    action: string,
    request_key: string,
    message: string,
  ) {
    return this.callAPI("POST", "/v1/policies/request_action", {
      action: action,
  ...
  public policies_create_procedure(
    procedure_name: string,
    parameters: any,
    requires: string,
    type: string,
  ...
  public policies_set_policy_projection(
    table_name: string,
    column_name: string,
  ...
  public add_http_apifilter(filter: any) {
    return this.callAPI("POST", "/v1/policies/create_http_apifilter", {
      filter: filter,
    });
  }

  public set_http_apifilter(filter: any) {
    return this.callAPI("PUT", "/v1/policies/set_http_apifilter/" + filter.id, {
      filter: filter,
    });
  }
  ...
  public delete_http_apifilter(filter_id: Number) {
    return this.callAPI(
      "DELETE",
      "/v1/policies/delete_http_apifilter/" + filter_id,
    );
  }
  ...
  public activate_http_apifilter(filter_id: Number) {
    return this.callAPI(
      "PUT",
      "/v1/policies/activate_http_apifilter/" + filter_id,
    );
  }
  ...
  public disable_http_apifilter(filter_id: Number) {
    return this.callAPI(
      "PUT",
      "/v1/policies/disable_http_apifilter/" + filter_id,
    );
  }
  ...
  public create_wireguard_peer(
    peer: WireguardPeerI,
  ): Promise<AddWireguardPeerResponse> {
  ...
  public send_wireguard_notification(
    username: string,
    device_name: string,
    config: string,
  ) {
    return this.callAPI("POST", "/v1/wireguard/notify", {
      username: username,
  ...
  public wireguard_disconnect_peer(peer_public_key: string) {
    return this.callAPI(
      "DELETE",
      "/v1/wireguard/" + encodeURIComponent(peer_public_key) + "/disconnect",
    );
  }
  ...
  public update_remote_desktop(
    id: number,
    name: string,
    details: any,
  ): Promise<any> {
    return this.callAPI("PUT", "/v1/rdp/" + id, {
      name: name,
      details: details,
    });
  }
  ...
  public get_remote_desktop_download_token(
    recording_id: number,
    token_type: string,
  ): Promise<any> {
    return this.callAPI(
      "GET",
      "/v1/rdp/" + recording_id + "/download/" + token_type,
    );
  }
  ...
  public get_remote_desktop_download_link(
    token: string,
    onprogress?: (message: string, percentage?: number) => void,
  ): Promise<any> {
    return new Promise((resolve, reject) => {
      let ws = new WebSocket(
        this._base.replace(/^http/, "ws") + "/rdp/tunnel?" + token,
      );
      ws.onmessage = (e: any) => {
  ...
  public setServerDomain(domain: string) {
    ...
    return this.get_smtp_cfg().then((smtpSettings: any) => {
      ...
      //SET WG
      calls.push(
        this.set_system_properties({ wireguard_public_address: domain }),
      );
      //RDP URI
  ...
  public restore_secret(secret: any, key?: string): Promise<any> {
    if (key) {
      return this.callAPI("POST", "/v1/secrets/", {
        restore: true,
        key,
        secret,
      });
  ...
  public export_secret(name: string, key?: string): Promise<any> {
    ...
    return this.callAPI(
      "GET",
      "/v1/secrets/" + encodeURIComponent(name) + "/export",
    );
  }
