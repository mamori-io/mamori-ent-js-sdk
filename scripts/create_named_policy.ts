...
let usage: string =
    "Usage:\n" +
    "   yarn ts-node --transpile-only examples/configure/create_named_policy.ts [--help] [--url <url>] <user> <password> <policy_name> <ds_name> <db> <schema> <table> <column> <masking function>\n" +
    "where:\n" +
